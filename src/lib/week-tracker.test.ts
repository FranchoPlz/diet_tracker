...
import { seriesCount, setActiveDay, startNextWeek, syncActiveDay } from './week-tracker';

describe('week tracker', () => {
  beforeEach(() => {
    appState.activePlanId = null;
    appState.weekTracker = { startedAt: '2026-09-01T12:00:00.000Z', activeDayIndex: 0, weekNumber: 1, trainingWeights: {} };
  });
  ...
  it('starts another week and optionally retains training weights', () => {
    ...
    expect(appState.weekTracker).toEqual({
      startedAt: '2026-09-08T12:00:00.000Z', activeDayIndex: 0, weekNumber: 2, trainingWeights: { '0:0': ['25'] },
    });
  });
